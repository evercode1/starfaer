...
return [
    ...
    [
        [
            ...
            'rough' => 'An A-type main-sequence star 
                                        ...
                                        stars have spectra which are defined 
                                        by strong hydrogen Balmer absorption 
                                        lines. They have masses from 1.4 to 
                                        2.1 times the mass of the Sun and surface 
                                        temperatures between 7600 and 11 500 K. 
                                        Bright and nearby examples are Altair, 
                                        Sirius A, and Vega. A-type stars are 
                                        fully radiative and thus are not 
                                        expected to harbor a magnetic dynamo. 
                                        As a consequence, because they do not 
        ...
        from hydrogen lines is intermediate. This leads to two or three 
        spectral types being given. For example, Sirius has been given a 
        spectral type of kA0hA0VmA1, indicating that it is A0 when judged 
        ...
        slower rotation than normal for A and B-type stars, although some 
        exhibit rotation velocities up to about 100 kilometers per second.
        They also have stronger magnetic fields than classical A- or B-type 
        stars in the case of HD 215441, reaching 33.5 kG 3.35 T. Typically 
        the magnetic field of these stars lies in the range of a few kG to 
        tens of kG. In most cases a field which is modelled as a simple 
        dipole is a good approximation and provides an explanation as to 
        why there is an apparent periodic variation in the magnetic field, 
        as if such a field is not aligned with the rotation axis—the field 
        strength will change as the star rotates. In support of this theory 
        it has been noted that the variations in magnetic field are 
        inversely correlated with the rotation velocity. 
        This model of a dipolar field, in which the magnetic 
        ...
        singly ionized helium in the blue-violet portion of the spectrum. All of the 
        spectral classes, including the B type, were subdivided with a numerical suffix 
        ...
        and had produced carbon and s-process elements in its interior. These nuclear fusion 
        products were mixed by convection to its surface. Some of that matter polluted the surface 
        layers of the main-sequence star as the donor star lost mass at the end of its AGB evolution, 
        ...
        composition as another spectral peculiarity. While the stars surface temperature 
        ...
        binary nature resolved the puzzle, putting the source of their spectral peculiarities 
        into a companion star which should have produced such material. The mass transfer e
        ...
        in the spectral classification system, and the surrounding square brackets 
        signifying forbidden lines. These stars frequently also show strong 
        hydrogen emission lines, but this feature is present in a variety of other 
        stars and is not sufficient to classify a B e object. Other observational 
        characteristics include optical linear polarization and often infrared 
        radiation that is much stronger than in ordinary B-class stars, 
        called infrared excess. As the B e nature is transient, Be-type stars 
        ...
        including many supergiants, Herbig Ae/Be stars, mass-transferring binary 
        systems, and B e stars. It is preferred to restrict usage of the term Be star 
       ...
       but a number of subgiants and giant stars are also included.',
        ...
        strong gravitational fields in their vicinities. Although the binary companion to 
        the pulsar is usually difficult or impossible to observe directly, its presence 
        ...
        line of sight. Nevertheless, their doubleness depends only on this optical effect; the 
        stars themselves are distant from one another and share no physical connection. A double 
        star can be revealed as optical by means of differences in their parallax measurements, 
        ...
        indirect techniques, such as spectroscopy spectroscopic binaries or astrometry astrometric 
        binaries. If a binary star happens to orbit in a plane along our line of sight, its components 
        ...
        binaries are Sirius, and Cygnus X-1 Cygnus X-1 being a well-known black hole. Binary stars 
        ...
        particle falling to the center of its star, because quantum processes create vacuum 
        polarization, which creates a form of degeneracy pressure, preventing spacetime and 
        the particles held within it from occupying the same space at the same time. 
        This vacuum energy is theoretically unlimited, and if built up quickly enough, 
        ...
        be severely gravitationally redshifted. It will appear almost exactly like a black hole. 
        It will feature Hawking radiation, as virtual particle pairs created in its vicinity 
        may still be split, with one particle escaping and the other being trapped.
        ...
        surface areas. Rather than expanding, however, red dwarfs with less than 
        0.25 solar masses are predicted to increase their radiative rate by increasing 
        ...
        quiescent zone with hotter stars generally being more luminous, but periodically 
        undergo large surface eruptions and move to a narrow zone where stars of all 
        luminosities have approximately the same temperature, around 8,000K. This active 
        ...
        LBVs from the hypergiant class and treat them separately. Blue hypergiants that 
        do not show LBV characteristics may be progenitors of LBVs, or vice versa, or both. 
        ...
        Standard theories of stellar evolution hold that the position of a star on the 
        Hertzsprung–Russell diagram should be determined almost entirely by the initial 
        mass of the star and its age. In a cluster, stars all formed at approximately 
        the same time, and thus in an H–R diagram for a cluster, all stars should 
        lie along a clearly defined curve set by the age of the cluster, with the 
        positions of individual stars on that curve determined solely by their initial 
        mass. With masses two to three times that of the rest of the main-sequence 
        cluster stars, blue stragglers seem to be exceptions to this rule. 
        ...
        immense amount of energy as the star is blown apart. The carbon detonation/deflagration 
        ...
        elements, or to implode into a neutron star or type II supernova as a larger star can, 
        ...
        matter having been expelled during the process of the companion\'s own late stage 
        stellar evolution. If the white dwarf gains enough matter, its internal pressure 
        and temperature will rise enough for carbon to begin fusing in its core. 
        Carbon detonation generally occurs at the point when the accreted matter pushes the 
        white dwarfs mass close to the Chandrasekhar limit of roughly 1.4 solar masses. This 
        is the mass at which gravity can overcome the electron degeneracy pressure which had 
        prevented the star from collapsing during its lifetime. The same also happens when 
       ...
       'rough' => 'A carbon star is typically an asymptotic giant branch star, a 
        ...
        compared to the classical C–N carbon stars. The term CH star was coined 
        ...
        space velocities characteristic of the older stellar population. These 
        were dubbed CH-like stars. Many CH stars are known to be members of 
        binary star systems, and it is reasonable to believe this is or was the 
        case for all CH stars. Like Barium stars, they are probably the result 
        ...
        meaning Circle of the Bears, Ursa Major, the Great Bear; and Ursa 
        ...
        easily strike nearby rocky planets, making it much harder for life to develop. 
        Due to their greater heat, the habitable zones of K-type stars are also much 
        wider than those of M-type stars. For all of these reasons, they may be the most 
        ...
        of time for life to develop on orbiting Earth-like, terrestrial planets. 
        In addition, K-type stars emit less ultraviolet radiation which can damage 
        DNA and thus hamper the emergence of nucleic acid based life than G-type 
        stars like the Sun. K-type main-sequence stars are also about three to 
        four times as abundant as G-type main-sequence stars, making planet searches easier.
        While M-type stars are also very abundant, they are more likely to have tidally 
        locked planets in orbit and are more prone to produce solar flares that would more 
        easily strike nearby rocky planets, making it much harder for life to develop. 
        ...
        spectra and are known as WNh stars; they are young extremely massive stars still 
        fusing hydrogen at the core, with helium and nitrogen exposed at the surface by 
        strong mixing and radiation-driven mass loss. A separate group of stars with WR 
        ...
        relative to their radius, giving them a very high density. The term compact star 
        is often used when the exact nature of the star is not known, but evidence 
        suggests that it is very massive and has a small radius, thus implying one 
        ...
        would end up with a large value for the cosmological constant and have 
        ...
        generate heat via annihilation reactions between the dark-matter particles. 
        ...
        the same way as projectiles, any light emitted at the surface of a dark star 
        ...
        a pair determines a curved arc of an orbit, or if the relative motion is 
        small compared to the common proper motion of both stars, it may be concluded 
        ...
        occultation eclipsing binaries, spectroscopy spectroscopic binaries, or anomalies in proper 
        motion astrometric binaries.
        Improvements in telescopes can shift previously non-visual binaries into visual binaries, 
        ...
        They are either much brighter than the Sun, or much fainter. To distinguish these 
        groups, he called them giant and dwarf stars, the dwarf stars being fainter 
        and the giants being brighter than the Sun. Most stars are currently classified 
        ...
        A blue dwarf is a hypothesized class of very-low-mass stars that increase in temperature 
        as they near the end of their main-sequence lifetime.
        A white dwarf is a star composed of electron-degenerate matter, thought to be the final 
        stage in the evolution of stars not massive enough to collapse into a neutron star or 
        black hole—stars less massive than roughly 9 solar masses.
        A black dwarf is a white dwarf that has cooled sufficiently such that it no longer emits any visible light.
        A brown dwarf is a substellar object not massive enough to ever fuse hydrogen into helium, 
       ...
       'wiki' => 'https://en.wikipedia.org/wiki/Dwarf_star',
        ...
        based upon strange quark matter, a condensate of up, down and strange quarks, 
        as well as speculative preon stars composed of preons, which are hypothetical 
        ...
        detecting cosmic objects that do not radiate electromagnetically or through 
        known particles. So it is not yet possible to verify novel cosmic objects 
        of this nature by distinguishing them from known objects. Candidates for such 
        ...
        stars a yellow-white hue. Because a main-sequence star is referred to as a 
        ...
        on flare stars are analogous to solar flares in that they are due to the magnetic 
        energy stored in the stars atmospheres. The brightness increase is across the 
        spectrum, from X rays to radio waves. The first known flare stars V1396 Cygni and AT Microscopii 
        were discovered in 1924. However, the best-known flare star is UV Ceti, 
        ...
        The more massive RS Canum Venaticorum variables RS CVn are also known to flare, 
        but it is understood that these flares are induced by a companion star in a 
        binary system which causes the magnetic field to become tangled. Additionally, 
        nine stars similar to the Sun had also been seen to undergo flare events prior to 
        the flood of superflare data from the Kepler observatory. It has been proposed 
        ...
        around 60 times the mass of Jupiter. Objects are considered stellar when they are about 75 
        ...
        where round is understood as whose surface is very nearly on the gravitational equipotential, 
        ...
        Like other main-sequence stars, a G-type main-sequence star is converting the 
        element hydrogen to helium in its core by means of nuclear fusion. The Sun, the 
        star to which the Earth is gravitationally bound in the Solar System and the 
        object with the largest apparent magnitude, is an example of a G-type 
        main-sequence star G2V type. Each second, the Sun fuses approximately 600 
        ...
        is in fact white, and its spectrum peaks in blue and green light, but it 
        can often appear yellow, orange or red through Earth\'s atmosphere due to 
        atmospheric Rayleigh scattering, especially at sunrise and sunset. In addition, 
        although the term "dwarf" is used to contrast yellow main-sequence stars from 
        ...
        such as Aldebaran or Alpha Tauri. Eventually the red giant sheds its outer 
        ...
        wildly up and down in intensity, and their spectra are highly variable unlike 
        other objects in space. The near complete lack of observational constraint 
        led to a profusion of theories, including evaporating black holes, magnetic 
        ...
        The progenitors of long GRBs are believed to be massive, 
        low-metallicity stars exploding due to the collapse of their cores. T
        he progenitors of short GRBs are thought to arise from mergers of 
        ...
        are an attempt to modernize the theory by incorporating quantum 
        ...
        a high-mass transfer between the two. It is observed to have caused a 
        ...
        their spectra. They are 2-8 Solar mass M☉ objects, still existing in the 
        star formation gravitational contraction stage and approaching the main 
        sequence i.e. they are not burning hydrogen in their center. In the 
        ...
        select really young stars near their birthplaces,
        Illumination of a nearby bright reflection nebula in order to guarantee 
        ...
        its atmosphere.  Hydrogen deficiency is unusual in a star, as hydrogen is typically the 
        ...
        classifications, except for specific well-defined groups such as the yellow 
        hypergiants, RSG red supergiants, or blue B e supergiants with emission spectra. 
        More commonly, hypergiants may be classed as Ia-0 or Ia+, but red supergiants 
        are rarely assigned these spectral classifications. Astronomers are mostly 
        ...
        mass, leading to their extremely long lifespan that offers plenty of time for 
        life to develop on orbiting Earth-like, terrestrial planets. In addition, 
        K-type stars emit less ultraviolet radiation which can damage DNA and thus 
        hamper the emergence of nucleic acid based life than G-type stars like the Sun.
        K-type main-sequence stars are also about three to four times as abundant as 
        G-type main-sequence stars, making planet searches easier. While M-type stars 
        are also very abundant, they are more likely to have tidally locked planets in 
        orbit and are more prone to produce solar flares that would more easily strike 
        nearby rocky planets, making it much harder for life to develop. Due to their 
        greater heat, the habitable zones of K-type stars are also much wider than 
        those of M-type stars. For all of these reasons, they may be the most favorable stars 
        ...
        Eridani itself is incorrectly listed as a Beta Cephei variable.  The AAVSO 
        International Variable Star Index defines a LERI type of variability, with 16 
        ...
        Thompson in 1992, but the first recorded burst of gamma rays thought to 
        have been from a magnetar had been detected on March 5, 1979. During the 
        ...
        Abhas Mitra in 1998, later on proposed by Darryl Leiter and Stanley Robertson a 
        generalization of the eternally collapsing object ECO proposed by Abhas Mitra in 1998. 
        A proposed observable difference between MECOs and black holes is that a MECO c
        ...
        in a series of stages to form helium, a sequence called the proton–proton chain. 
        Above this mass, in the upper main sequence, the nuclear fusion process mainly 
        uses atoms of carbon, nitrogen and oxygen as intermediaries in the CNO cycle 
        that produces helium from hydrogen atoms. Main-sequence stars with more than 
        two solar masses undergo convection in their core regions, which acts to 
        stir up the newly created helium and maintain the proportion of fuel needed 
        for fusion to occur. Below this mass, stars have cores that are entirely 
        radiative with convective zones near the surface. With decreasing stellar 
        mass, the proportion of the star forming a convective envelope steadily increases. 
        ...
        behavior of a star now depends on its mass, with stars below 0.23 M☉ 
        ...
        Their rotation is relatively slow, and as a consequence their atmosphere is relatively calm. 
        It is thought, but has not been proven, that some types of atoms sink under 
        ...
        a mass between 1.4 and 2.16 solar masses. They result from the supernova explosion 
        of a massive star, combined with gravitational collapse, that compresses the core past 
        the white dwarf star density to that of atomic nuclei. Once formed, they no longer actively 
        generate heat, and cool over time; however, they may still evolve further through collision 
        or accretion. Most of the basic models for these objects imply that neutron stars are 
        composed almost entirely of neutrons subatomic particles with no net electrical 
        charge and with slightly larger mass than protons); the electrons and protons present 
        in normal matter combine to produce neutrons at the conditions in a neutron star. 
        Neutron stars are supported against further collapse by neutron degeneracy 
        pressure, a phenomenon described by the Pauli exclusion principle, just as white 
        ...
        chunk of the Earth a cube with edges of about 800 metres. Their magnetic fields are 
        ...
        detectable as pulsars. Indeed, the discovery of pulsars by Jocelyn Bell Burnell in 
        1967 was the first observational suggestion that neutron stars exist. The radiation 
        from pulsars is thought to be primarily emitted from regions near their magnetic poles. 
        If the magnetic poles do not coincide with the rotational axis of the neutron star, 
        the emission beam will sweep the sky, and when seen from a distance, if the observer 
        is somewhere in the path of the beam, it will appear as pulses of radiation coming 
        from a fixed point in space the so-called lighthouse effect. The fastest-spinning 
        ...
        certain instances, such as if they are a pulsar or part of a binary system. 
        Slow-rotating and non-accreting neutron stars are almost undetectable; however, 
        since the Hubble Space Telescope detection of RX J185635-3754, a few nearby 
        neutron stars that appear to emit only thermal radiation have been detected. 
        ...
        Additionally, such accretion can "recycle" old pulsars and potentially cause 
        them to gain mass and spin-up to very fast rotation rates, forming the so-called 
        millisecond pulsars. These binary systems will continue to evolve, and eventually 
        the companions can become compact objects such as white dwarfs or neutron stars 
        themselves, though other possibilities include a complete destruction of the 
        companion through ablation or merger. The merger of binary neutron stars may be 
        the source of short-duration gamma-ray bursts and are likely strong sources of 
        gravitational waves. In 2017, a direct detection GW170817 of the gravitational 
        ...
        Earth are O type. Due to high temperature and luminosity, O-type stars end their 
        lives rather quickly in violent supernova explosions, resulting in black holes or 
        ...
        any surrounding material and are largely responsible for the distinct coloration of a 
        galaxys arms. Furthermore, O-type stars are also frequent in multiple star systems where 
        ...
        The class names provide a good idea of the peculiarities that set them apart from 
        other stars on or near the main sequence. The Am stars CP1 stars show weak lines 
        of singly ionized Ca and/or Sc, but show enhanced abundances of heavy metals. They also 
        tend to be slow rotators and have an effective temperature between 7000 K and 10 000 K. 
        The Ap stars CP2 stars are characterized by strong magnetic fields, enhanced abundances 
        of elements such as Si, Cr, Sr and Eu, and are also generally slow rotators. The effective 
        temperature of these stars is stated to be between 8000 K and 15 000 K, but the 
        issue of calculating effective temperatures in such peculiar stars is complicated 
        by atmospheric structure. The HgMn stars CP3 stars are also classically placed within 
        the Ap category, but they do not show the strong magnetic fields associated with classical 
        Ap stars. As the name implies, these stars show increased abundances of singly ionized 
        Hg and Mn. These stars are also very slow rotators, even by the standards of 
        CP stars. The effective temperature range for these stars is quoted at between 
        ...
        These processes cause some elements, particularly He, N and O, to settle out in the 
        atmosphere into the layers below, while other elements such as Mn, Sr, Y and Zr are 
        levitated out of the interior to the surface, resulting in the observed spectral 
        peculiarities. It is assumed that the centers of the stars, and the bulk 
        compositions of the entire star, have more normal chemical abundance mixtures 
        which reflect the compositions of the gas clouds from which they formed. 
        In order for such diffusion and levitation to occur and the resulting layers 
        ...
        class or some further specific label. The phrase chemically peculiar star 
        without further specification usually means a member of one of the hot 
        main sequence types described above. Many of the cooler chemically 
        peculiar stars are the result of the mixing of nuclear fusion products 
        from the interior of the star to its surface; these include most of the 
        carbon stars and S-type stars. Others are the result of mass transfer 
        ...
        and are characterized by atmospheres with little hydrogen and absorption 
        lines for helium, carbon and oxygen. Their surface gravity is typically 
        between 104 and 106 meters per second squared. Some PG 1159 stars are 
        ...
        and 3,000 seconds.The first known star of this type is also PG 1159-035, 
        which was found to be variable in 1979, and was given the variable star 
        ...
        of the star well before a singularity is formed, and indeed, well before the 
        Planck scale for distance. Since a Planck star is calculated to be considerably 
        ...
        a similarly extreme degree. Seen from outside, the rebound from a Planck star of 
        stellar mass takes longer than the timescale of the universe to date, such that 
        stellar mass black holes seem to be stable to an external observer. Even more elegantly, 
        ...
        of being the naked-eye star closest to the Earths north celestial pole. The name Polaris, 
        introduced in the 18th century, is shortened from New Latin stella polaris, meaning pole star. 
        Polaris is also known as Lodestar, Guiding Star, or North Star from its property of 
        remaining in a fixed position throughout the course of the night and its use in 
        celestial navigation. It is a dependable, though inexact, indicator of the direction 
        toward the geographic north pole; it is virtually fixed, and its angle of elevation 
        ...
        time. Precession causes the celestial poles to trace out circles on the celestial 
        ...
        other two populations, because planets, particularly terrestrial planets, are 
        thought to be formed by the accretion of metals.[11] However, observations of the 
        Kepler data-set have found smaller planets around stars with a range of 
        metallicities, while only larger, potential gas giant planets are concentrated 
        around stars with relatively higher metallicity — a finding that has implications 
        ...
        chemical makeup of the universe, even 13.8 billion years after the Big Bang. 
        However, metal-poor objects are even more ancient. These objects are formed 
        during an earlier time of the universe. Intermediate Population I stars are 
        ...
        they often have a higher ratio of alpha elements O, Si, Ne, etc. 
        relative to Fe as compared to Population I stars; current theory suggests 
        ...
        including the HK objective-prism survey of Timothy C. Beers et al. and the
         ...
         faint quasars. Thus far, they have uncovered and studied in detail about
          ten very metal-poor stars such as Snedens Star, Cayrels Star, BD +17° 3248, 
          and three of the oldest stars known to date: HE0107-5240, HE1327-2326 
          and HE 1523-0901. Caffaus star was identified as the most metal-poor star yet 
          when it was found in 2012 using Sloan Digital Sky Survey data. However, i
          n February 2014 the discovery of an even lower metallicity star was announced, 
          SMSS J031300.36-670839.3 located with the aid of SkyMapper astronomical survey data. 
        ...
        observed directly. Indirect evidence for their existence has been found in a
         gravitationally lensed galaxy in a very distant part of the universe.
         
         Their existence may account for the fact that heavy elements — which could not 
         have been created in the Big Bang — are observed in quasar emission spectra. 
         They are also thought to be components of faint blue galaxies. These stars likely 
         triggered the universes period of reionization, a major phase transition of gases 
         leading to the opacity observed today. Observations of the galaxy UDFy-38135539 
         suggest it may have played a role in this reionization process. The European Southern 
         Observatory discovered a bright pocket of early population stars in a very bright 
         galaxy Cosmos Redshift 7 from the reionization period around 800 million years 
        ...
        that the sub-subatomic particles would have come before subatomic particles, 
        which came before particles, and that the original stars were made of these 
        sub-subatomic particles, with most gradually becoming made of sub-particles, 
        and then particles. However, the theory postulates that it is possible for some 
        stars made of the sub-subatomic particles to remain.[3] It is believed that 
    ...
    it is optically visible, and appears on the stellar birthline in the 
    Hertzsprung-Russell diagram. At this point, the star has acquired nearly all 
    of its mass but has not yet started hydrogen burning i.e. nuclear fusion of hydrogen. 
    The star then contracts, its internal temperature rising until it begins hydrogen 
    burning on the zero age main sequence. This period of contraction is the pre-main 
    sequence stage.  An observed PMS object can either be a T Tauri star, if it has 
    fewer than 2 solar masses M☉, or else a Herbig Ae/Be star, if it has 2 to 8 M☉. 
    Yet more massive stars have no pre-main-sequence stage because they contract too 
    ...
    'wiki' => 'https://en.wikipedia.org/wiki/Pre-main-sequence_star'
        ...
        when the light is pointed in the direction of an observer, and is responsible 
        for the pulsed appearance of emission. Neutron stars are very dense, and 
        have short, regular rotational periods. This produces a very precise 
        ...
        stars, with helium-dominated atmospheres and the spectral type DB; 
        and GW Vir stars, with atmospheres dominated by helium, carbon, and oxygen, 
        and the spectral type PG 1159. Some authors also include non-PG 1159 
        stars in the class of GW Vir stars. GW Vir stars may be subdivided 
        into DOV and PNNV stars; they are not, strictly speaking, 
        white dwarfs but pre-white dwarfs which have not yet reached the white dwarf 
        ...
        the period of fusion. Red dwarfs therefore develop very slowly, maintaining a constant 
        luminosity and spectral type for trillions of years, until their fuel is depleted. 
        ...
        fusing helium into carbon in their cores via the triple-alpha process; and the 
        ...
        shows that such a star is only marginally bound, and is unstable to either 
        collapse or explode. This instability is believed to limit the mass of 
        main-sequence stars to a couple of hundred solar masses or so. Stars of 
        ...
        are intermediate between carbon stars and normal giants. They can be 
        grouped into two classes: intrinsic S stars, which owe their spectra to 
        ...
        luminous and longer-lived, often smaller-amplitude semiregular or 
        irregular variables. S stars are relatively rare, with intrinsic 
        ...
        They may exhibit irregular variations in their luminosity due to the outflow of 
        matter. The shell stars are fast rotators, giving a partial explanation on the 
        mechanism, but shell stars are still considered enigmatic. Shell stars 
        belong to spectral types O7.5 to F5, but their spectra are characterized 
        by enormously widened absorption lines due to fast rotation and 
        the disc that contributes also to other spectral peculiarities. 
        ...
        way as ordinary quark matter could. Such strange stars will naturally 
        have a crust layer of neutron star material. The depth of the crust 
        layer will depend on the physical conditions and circumstances of 
        the entire star and on the properties of strange quark matter in general.  
        ...
        Ionized helium is prominent in their spectra. Gravity acceleration is expressed 
        ...
        is readily revealed by their light-curves and spectra. There are multiple 
        models for what conditions may produce an SLSN, including core collapse 
        ...
        after the prototype, T Tauri, a young star in the Taurus star-forming region. 
        They are found near molecular clouds and identified by their optical variability 
        and strong chromospheric lines. T Tauri stars are pre-main-sequence stars in the 
        process of contracting to the main sequence along the Hayashi track, a 
        luminosity–temperature relationship obeyed by infant stars of less than 
        3 solar masses M☉ in the pre-main-sequence phase of stellar evolution. 
        ...
        metal technetium. The most stable isotope of technetium is 98Tc with a
         ...
         the metal to be material from before the stars formation. 
        ...
        Members of this class of stars switch to helium shell burning with 
        an interval of some 100,000 years, in dredge-ups. Technetium stars 
        ...
        while its volume is comparable to that of Earth. A white dwarfs faint 
        luminosity comes from the emission of stored thermal energy; no fusion takes 
        place in a white dwarf wherein mass is converted to energy. The nearest known 
        white dwarf is Sirius B, at 8.6 light years, the smaller component of the 
        Sirius binary star. There are currently thought to be eight white dwarfs 
        ...
        period of a main-sequence star of low or medium mass ends, such a star will 
        expand to a red giant during which it fuses helium to carbon and oxygen 
        in its core by the triple-alpha process. If a red giant has insufficient mass to 
        generate the core temperatures required to fuse carbon around 1 billion K, 
        an inert mass of carbon and oxygen will build up at its center. After such 
        a star sheds its outer layers and forms a planetary nebula, it will leave 
        behind a core, which is the remnant white dwarf. Usually, white dwarfs are 
        composed of carbon and oxygen. If the mass of the progenitor is between 8 
        and 10.5 solar masses M☉, the core temperature will be sufficient to fuse 
        ...
        degeneracy pressure, causing it to be extremely dense. The physics of 
        degeneracy yields a maximum mass for a non-rotating white dwarf, 
        the Chandrasekhar limit—approximately 1.44 times of M☉—beyond which it 
        cannot be supported by electron degeneracy pressure. A carbon-oxygen 
        ...
        crystallize starting with the core. The stars low temperature means it will 
        no longer emit significant heat or light, and it will become a cold black dwarf. 
        Because the length of time it takes for a white dwarf to reach this state 
        is calculated to be longer than the current age of the universe approximately 13.8 billion years,
        ...
        lines in their spectra and are known as WNh stars; they are young extremely 
        massive stars still fusing hydrogen at the core, with helium and nitrogen 
        exposed at the surface by strong mixing and radiation-driven mass loss. 
        A separate group of stars with WR spectra are the central stars of 
        ...
        They are amongst the most visually luminous stars, with absolute magnitude MV 
        around −9, but also one of the rarest with just 15 known in the Milky Way 
        and six of those in just a single cluster. They are sometimes referred to as cool 
