<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">All StarTypes</h1>
                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                ...
                                <a v-bind:href="'/star-type/' + row.Id + '-' + row.Slug"> {{ row.Name }}</a>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/all-star-types-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/all-star-types-data', this);
