<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">World Terms Glossary</h1>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/all-world-terms-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/all-world-terms-data', this);
