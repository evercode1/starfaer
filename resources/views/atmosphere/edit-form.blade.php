<form class="mt-20"
      role="form"
      method="POST"
      action="{{ url('/atmosphere/'. $atmosphere->id) }}"
...
<!-- name input -->
    ...
    <!-- is_active select -->
            ...
            <div class="{{ $errors->has('is_active') ? ' has-error' : '' }}">
                ...
                <select id="is_active" name="is_active">
                    ...
                    <option value="{{ $atmosphere->is_active }}">{{ $atmosphere->is_active == 1 ? 'Yes' : 'No' }}</option>

                    @if($atmosphere->is_active == 1)
    ...
    <!-- description input -->
        ...
        <div class="{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <textarea id="description" name="body">{!! $atmosphere->description !!}</textarea>
