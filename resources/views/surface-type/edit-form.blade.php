<form class="mt-20"
      role="form"
      method="POST"
      action="{{ url('/surface-type/'. $surfaceType->id) }}"
...
<!-- name input -->
    ...
    <!-- is_active select -->
            ...
            <div class="{{ $errors->has('is_active') ? ' has-error' : '' }}">
                ...
                <select id="is_active" name="is_active">
                    ...
                    <option value="{{ $surfaceType->is_active }}">{{ $surfaceType->is_active == 1 ? 'Yes' : 'No' }}</option>

                    @if($surfaceType->is_active == 1)
    ...
    <!-- description input -->
        ...
        <div class="{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <textarea id="description" name="body">{!! $surfaceType->description !!}</textarea>
