...
Route::get('api/contact-topic-data', 'ApiController@ContactTopicData')->middleware(['auth', 'admin']);;
Route::get('api/content-data', 'ApiController@contentData')->middleware(['auth', 'admin']);
